...
#SBATCH --output=/storage/scratch1/9/spanse30/PTT/instrumentation/PTT/plots/slurm_%j.out
#SBATCH --error=/storage/scratch1/9/spanse30/PTT/instrumentation/PTT/plots/slurm_%j.err

# Generate timestamp (YYYYMMDD_HHMMSS)
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")

# Create output folder
RESULTS_DIR=/storage/scratch1/9/spanse30/PTT/instrumentation/PTT_global_hard/plots
mkdir -p $RESULTS_DIR
...
srun python analyze_ptt_features.py \
    --features_dir /storage/scratch1/9/spanse30/PTT/instrumentation/PTT_global_hard \
    --out_dir $RESULTS_DIR 
